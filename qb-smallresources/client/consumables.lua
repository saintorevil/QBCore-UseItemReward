...
RegisterNetEvent('consumables:client:UseMenu', function(itemType)
    local item = math.random(#Config.RewardsGifts)
    QBCore.Functions.Progressbar("Menu_Gift2", "Abrir Menu", math.random(500, 2000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerServerEvent('consumables:server:receberMenu', Config.RewardsGifts[item].item, math.random(Config.RewardsGifts[item].minAmount, Config.RewardsGifts[item].maxAmount))
        TriggerEvent('inventory:client:ItemBox', QBCore.Shared.Items[Config.RewardsGifts[item].item], "add")
...
RegisterNetEvent('consumables:client:UseMenuGift', function(itemType)
    local item = math.random(#Config.RewardsSmall)
    QBCore.Functions.Progressbar("Menu_Gift", "Abrir Presente", math.random(500, 2000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(PlayerPedId(), "amb@prop_human_bum_bin@idle_b", "idle_d", 1.0)
        QBCore.Functions.Notify("Found Something", "success")
        TriggerServerEvent('consumables:server:receberPresente', Config.RewardsSmall[item].item, 1)
